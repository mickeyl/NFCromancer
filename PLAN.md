...
> template match). Logging goes through CornucopiaCore. Phases 2 (mock library) and 3 (client fixtures with a headless
> XCTest) are done too; only the Simsalabim integration (phase 4) remains.
